...
class ProductosModelFile{
    ...
    async guardarArchivo(productos) {
        await fs.promises.writeFile(this.nombreArchivo, JSON.stringify(productos, null, '\t')) // \t permite que los datos que se graban en productos.dat se vean
    }                                                                                     // en una columna, y no en una línea continua
